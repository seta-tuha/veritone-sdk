...
describe('MediaInfoPanel', () => {
  it('should show media info panel', () => {
    ...
    expect(
      ...
      'tag1, longer tag, a bit longer tag, very very very very very very very very very very very very very very long tag, tag 3, tag 4, tag 5, tag 6, tag 7, tag 8, tag 9, tag 0, hakuna, matata'
    );
